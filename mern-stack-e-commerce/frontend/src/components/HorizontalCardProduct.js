...
import displayNISCurrency from '../helpers/displayCurrency'
                    ...
                    <Link to={"product/"+product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                        ...
                        <div className='p-4 grid'>
                            ...
                            <div className='flex gap-3'>
                                <p className='text-red-600 font-medium'>{ displayNISCurrency(product?.sellingPrice) }</p>
                                <p className='text-slate-500 line-through'>{ displayNISCurrency(product?.price)  }</p>
                            </div>
