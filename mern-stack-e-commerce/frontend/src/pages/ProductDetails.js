...
const ProductDetails = () => {
  ...
  const handleAddToWishlist = async (e, id) => {
    ...
    try {
      ...
      const response = await fetch(SummaryApi.addWishlist.url, {
        method: SummaryApi.addWishlist.method,
        credentials : 'include',
        headers: {
          'Content-Type': 'application/json',
        },
            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-3 my-2'>
                  ...
                  <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-red-600 hover:text-red-600 hover:bg-white' onClick={(e)=>handleAddToWishlist(e,data?._id)}>Add To Wishlist</button>
